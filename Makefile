...
restart-full-stack:
		cd full-stack; LOGIN_CONSENT_VERSION=v1.0.0-beta.4 HYDRA_VERSION=v1.0.0-beta.4 KETO_VERSION=v1.0.0-beta.4 OATHKEEPER_VERSION=v1.0.0-beta.4 docker-compose restart

rm-full-stack:
		cd full-stack; LOGIN_CONSENT_VERSION=v1.0.0-beta.4 HYDRA_VERSION=v1.0.0-beta.4 KETO_VERSION=v1.0.0-beta.4 OATHKEEPER_VERSION=v1.0.0-beta.4 docker-compose kill
		cd full-stack; LOGIN_CONSENT_VERSION=v1.0.0-beta.4 HYDRA_VERSION=v1.0.0-beta.4 KETO_VERSION=v1.0.0-beta.4 OATHKEEPER_VERSION=v1.0.0-beta.4 docker-compose rm -f
